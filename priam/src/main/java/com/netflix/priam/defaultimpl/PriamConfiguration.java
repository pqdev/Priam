...
//        DEFAULT_AVAILABILITY_ZONES =  StringUtils.join(zone, ",");
  ...
  @Override
   ...
   public String getInternodeEncryption()
    ...
    {
        return config.get(CONFIG_SERVER_ENCRYPTION_KEYSTORE, "/etc/cassandra/conf/.keystore");
    }
    ...
    {
        return config.get(CONFIG_SERVER_ENCRYPTION_TRUSTSTORE, "/etc/cassandra/conf/.truststore");
    }
