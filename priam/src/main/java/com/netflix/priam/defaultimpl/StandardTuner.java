...
public class StandardTuner implements CassandraTuner
{
    ...
    public void writeAllProperties(String yamlLocation, String hostname, String seedProvider) throws IOException
    {
		...
		// 'hostname' needs to be private_ip for VPC
        map.put("listen_address", config.getHostname());
        map.put("rpc_address", config.getHostname());
		// broadcast needs to be public_ip for VPC in multi region
		...
		//ConfigurationException: Invalid yaml
